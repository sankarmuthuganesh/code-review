 ...
 * CheckBoxListt#getCheckBoxListSelectionModel()}. If you need to add a check to a check box or to find out if a check
 ...
 */
public class CheckBoxListt extends JList {
     ...
     */
    public CheckBoxListt(final Vector<?> listData) {
        super(listData);
        init();
    }
     ...
     */
    public CheckBoxListt(final Object[] listData) {
        super(listData);
        init();
    }
     ...
     */
    public CheckBoxListt(ListModel dataModel) {
        super(dataModel);
        init();
    }
    ...
    protected static class Handler implements MouseListener, MouseMotionListener, KeyListener, ListSelectionListener, PropertyChangeListener, ListDataListener {
        protected CheckBoxListt _list;
        int hotspot = new JCheckBox().getPreferredSize().width;


        public Handler(CheckBoxListt list) {
            _list = list;
        }
